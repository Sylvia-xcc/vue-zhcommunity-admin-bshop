  ...
  <div style="padding:30px;">
    <el-form ref="form" :model="form" label-width="140px">
      ...
      <el-form-item label="属性规格设置：">
        ...
        <router-link to="/product/attribute/add">
          <el-button type="text">去添加</el-button>
        </router-link>
      </el-form-item>
      <CreateAttribute
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      if(tmp.length<=0)
        return;
      setProductGuige({ pid: this.pid, guigeList: JSON.stringify(tmp) }).then(
        res => {
    ...
    updateAttribute(obj) {
      console.log("-------- updateAttribute:", obj);
      let list = this.form.list;
